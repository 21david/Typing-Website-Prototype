translationData.spanish = {
    ...
    // Results
    part1: (WPM) => WPM? '¡Buen trabajo!' : 'Lastima.',
    part2: (WPM) => `Escribiste a <strong style="color: green; font-size: 2.1em;"> ${WPM}</strong> palabras por minuto.`,
    correctWords: 'Palabras correctas:',
    correctLetters: 'Letras correctas:',
    wrongWords: 'Palabras incorrectas:'
};